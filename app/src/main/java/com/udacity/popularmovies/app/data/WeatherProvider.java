...
//        matcher.addURI(authority, MoviesContract.PATH_WEATHER, WEATHER);
//        matcher.addURI(authority, MoviesContract.PATH_WEATHER + "/*", WEATHER_WITH_LOCATION);
//        matcher.addURI(authority, MoviesContract.PATH_WEATHER + "/*/#", WEATHER_WITH_LOCATION_AND_DATE);
//
//        matcher.addURI(authority, MoviesContract.PATH_LOCATION, LOCATION);
//        return matcher;
//    }
//
//    /*
...
//        if (values.containsKey(MoviesContract.WeatherEntry.COLUMN_DATE)) {
//            long dateValue = values.getAsLong(MoviesContract.WeatherEntry.COLUMN_DATE);
//            values.put(MoviesContract.WeatherEntry.COLUMN_DATE, MoviesContract.normalizeDate(dateValue));
//        }
//    }
//
//    @Override
